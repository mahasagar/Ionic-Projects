angular.module('myAppName.services', []).factory('Ads', function($cordovaDevice,$rootScope) {
  var o = {
  };
  ...
  o.getBanner = function(container){
    ...
    var manufacturer = $rootScope.manufacturer;
    var model = $rootScope.model;
    var uuid = $rootScope.uuid;
    // Required parameters.
    var publisherId = '*** PublishId ***';
    var productId ='*** ur Product ID ***';
    var width = 320;
    var height =50;
    // Optional parameters.
